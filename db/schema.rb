...
ActiveRecord::Schema.define(version: 2018_11_24_222642) do
  ...
  create_table "teams", force: :cascade do |t|
    ...
    t.string "keypair_name", limit: 100
    t.string "keypair_filename", limit: 250
    t.string "bucket_name", limit: 100
    t.string "stack_name", limit: 100
